...
public class Remove extends DamlRecord<Remove> {
  ...
  public Remove(InstrumentKey instrument) {
  ...
  public String toString() {
    return String.format("com.daml.quickstart.model.daml.finance.interface$.instrument.token.factory.Remove(%s)",
        this.instrument);
  }
}
