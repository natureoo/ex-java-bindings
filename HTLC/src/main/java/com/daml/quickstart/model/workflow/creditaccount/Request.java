package com.daml.quickstart.model.workflow.creditaccount;
...
public final class Request extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("91deeb52981e7064dbcf05e8dd2a81ef0d8a25fe4aaff70e56ec84fcb11aa28d", "Workflow.CreditAccount", "Request");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Request> COMPANION = 
      new ContractCompanion.WithoutKey<>("com.daml.quickstart.model.workflow.creditaccount.Request",
  ...
  public Request(AccountKey account, InstrumentKey instrument, BigDecimal amount) {
   ...
   */
  @Deprecated
  public Update<Exercised<Base.ContractId>> createAndExerciseAccept() {
  ...
  public static Update<Created<com.daml.ledger.javaapi.data.codegen.ContractId<Request>>> create(
      AccountKey account, InstrumentKey instrument, BigDecimal amount) {
    return new Request(account, instrument, amount).create();
  }
  ...
  private static ValueDecoder<Request> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Request(account, instrument, amount);
    } ;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.account, this.instrument, this.amount);
  }

  @Override
  public String toString() {
    return String.format("com.daml.quickstart.model.workflow.creditaccount.Request(%s, %s, %s)",
        this.account, this.instrument, this.amount);
  }
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises<Cmd> {
    ...
    default Update<Exercised<Base.ContractId>> exerciseAccept() {
