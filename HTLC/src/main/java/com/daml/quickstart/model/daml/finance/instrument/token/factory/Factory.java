package com.daml.quickstart.model.daml.finance.instrument.token.factory;
...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("2cf62ae345caf0cd6f3ff0fe4a1e35a3605cc77dfbefb5b004bc8e6b8be0066e", "Daml.Finance.Instrument.Token.Factory", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "com.daml.quickstart.model.daml.finance.instrument.token.factory.Factory", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("com.daml.quickstart.model.daml.finance.instrument.token.factory.Factory(%s, %s)",
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Factory> implements Exercises<ExerciseCommand> {
    ...
    public com.daml.quickstart.model.daml.finance.interface$.instrument.token.factory.Factory.ContractId toInterface(
        com.daml.quickstart.model.daml.finance.interface$.instrument.token.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new com.daml.quickstart.model.daml.finance.interface$.instrument.token.factory.Factory.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        com.daml.quickstart.model.daml.finance.interface$.instrument.token.factory.Factory.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public com.daml.quickstart.model.daml.finance.interface$.instrument.token.factory.Factory.CreateAnd toInterface(
        com.daml.quickstart.model.daml.finance.interface$.instrument.token.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new com.daml.quickstart.model.daml.finance.interface$.instrument.token.factory.Factory.CreateAnd(COMPANION, this.createArguments);
    }
